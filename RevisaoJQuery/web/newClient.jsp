                                ...
                                <div class="col-md-12">
                                    ...
                                    <form method="post" action="new">
                                        ...
                                        <div class="form-group inputs has-feedback" id="name">
                                            <input type="text" class="form-control inputLogin" name="name" required="required">
                                        ...
                                        <div class="form-group inputs has-feedback" id="email">
                                            <input type="text" class="form-control inputLogin" name="email" required="required">
                                        ...
                                        <div class="form-group inputs has-feedback" id="cpf">
                                            <input type="text" class="form-control inputLogin" name="cpf" required="required">
                                        ...
                                        <div class="form-group inputs has-feedback" id="user">
                                            <input type="text" class="form-control inputLogin" name="user" required="required">
                                        ...
                                        <div class="form-group inputs has-feedback" id="passwd">
                                            <input type="password" class="form-control inputLogin" name="passwd" required="required">
